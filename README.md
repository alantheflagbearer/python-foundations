...
**Currently on Day 54** of 365. Full syllabus: [`full_syllabus_days_1_365.md`](full_syllabus_days_1_365.md).
...
| 8 | 49–54 (of 49–55) | Classic CNN Architectures + Regularization — in progress | [→ folder](week-08-classic-cnn-architectures) |
...
Starting with Week 6, the same small neural-network library — written entirely in NumPy, no framework — is extended week over week: the `net.forward()` / `net.backward()` core built on Day 36 is still what every later script, all the way through Day 54, trains against.
...
| ![Plain vs. BN vs. BN+residual](week-08-classic-cnn-architectures/batchnorm_vs_plain_vs_resnet.png) Batch norm alone beats BN+residual, same failing lr — Day 54 | |
